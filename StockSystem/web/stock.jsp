...
<ul class="layui-nav layui-bg-cyan"lay-filter="">
    ...
    <li class="layui-nav-item" id="<%=request.getContextPath()%>/cart"><a href="cart.jsp">进货订单</a></li>
    <li class="layui-nav-item"><a href="<%=request.getContextPath()%>/login.jsp">退出</a></li>
</ul>

<div class="layui-body content">
    <form action="<%=request.getContextPath()%>/servlets/StockSearchServlet">
        <div class="layui-form-item">
            <label class="layui-form-label">检索</label>
            <div class="layui-input-block">
                <input type="text" name="stoInfo" lay-verify="required" lay-reqtext="输入为空，请重新输入" placeholder="请输入进货商名或者编号" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-input-block">
